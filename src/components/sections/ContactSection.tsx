        ...
        <div className="grid lg:grid-cols-2 gap-12 items-start">
          ...
          >
            <div className="space-y-8">
              {/* WhatsApp Button */}
              <Card className="border-0 shadow-lg bg-gradient-to-r from-green-500 to-green-600">
                <CardContent className="p-8 text-center">
                  <h3 className="text-2xl font-bold text-white mb-4">
                    Quick Chat on WhatsApp
                  </h3>
                  <p className="text-green-100 mb-6">
                    Get instant replies and discuss your project requirements
                  </p>
                  <CTAButton
                    variant="whatsapp"
                ...
                <CardContent className="p-0">
                  <div className="w-full h-64 bg-gray-200 rounded-lg flex items-center justify-center">
                    <div className="text-center">
                      ...
                      <p className="text-sm text-gray-500">Replace with actual map embed</p>
                    </div>
                  </div>
                </CardContent>
              </Card>
